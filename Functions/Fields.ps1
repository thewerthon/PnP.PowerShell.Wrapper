...
Function Set-Field {
    ...
    Process {
        ...
        If ($FieldParams) {
            ...
            Invoke-Operation -Message "Setting parameters to field: $($Field.InternalName)" -DisplayInfos:$DisplayInfos -SuppressErrors:$SuppressErrors -Silent:$Silent -Operation {
